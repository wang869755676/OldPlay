...
import com.td.oldplay.ui.shop.activity.ShopCarActivity;
...
public class ShopDetailActivityq extends BaseFragmentActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        getData();
        List<CommentBean> da = new ArrayList<>();
        da.add(new CommentBean());
        da.add(new CommentBean());
        da.add(new CommentBean());
        da.add(new CommentBean());
        da.add(new CommentBean());
        ...
        recycler.setAdapter(new CommentAdapter(mContext, R.layout.item_comment_shopdetail, da));
