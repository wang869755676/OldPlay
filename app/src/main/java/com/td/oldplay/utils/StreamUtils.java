...
public class StreamUtils {
    ...
    public static final String APP_SERVER_BASE = "http://spark.echohu.top";
    ...
    private static String requestStreamURL(String roomName) {
        ...
        String url = APP_SERVER_BASE + "/get/?service=generateRTMPpublishURL";
    ...
    public static String requestRoomToken(String userId, String roomName) {
        //String url = APP_SERVER_BASE + "/room/" + roomName + "/user/" + userId + "/token";
        String url = APP_SERVER_BASE + "/get/?service=generateRoomToken&userId="+userId+"&roomName="+roomName+"&role=admin";
        //http://spark.echohu.top/get/?service=generateRoomToken&userId=user01&roomName=testroom&role=user
        //return doRequest("POST", url);
        return doRequest("GET", url);
    }
    public static String createRoom(String userId, String roomName) {
        //String url = APP_SERVER_BASE + "/room/" + roomName + "/user/" + userId + "/token";
        String url = APP_SERVER_BASE + "/get/?service=createRoom&roomName="+roomName+"&userid="+userId;
        //http://spark.echohu.top/get/?service=generateRoomToken&userId=user01&roomName=testroom&role=user
        //return doRequest("POST", url);
        return doRequest("GET", url);
    }
